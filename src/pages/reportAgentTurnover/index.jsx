...
import {
  baseUrl,
  EXPORT_AGENT_TURN_OVER,
  GET_AGENT_TURN_OVER,
  GET_CHILD_FACILITIES,
  SINGLE_USER,
} from "../../helpers/api-routes";
import { configReq } from "../../helpers/functions";
import WalletAgentModal from "./modal";

const ReportAgentTurnover = () => {
  ...
  return (
    <>
          ...
          <>
            <div className="flex md:gap-4 gap-1 flex-wrap justify-between">
              ...
              <div className="flex items-center gap-4 col-span-4 md:justify-end">
                ...
                {userPermissions?.ReportUserTurnover.export && (
                  <Exports
      ...
      <WalletAgentModal
        open={openModal}
        prevData={editingData?.id ? editingData : selected[0]}
        value={userData}
        setAllRows={setAllRows}
        allRows={allRows}
        selected={selected}
...
export default ReportAgentTurnover;
